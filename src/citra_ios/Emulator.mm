...
+ ()JITTS {
    // source : pojavlauncher
    // https://github.com/PojavLauncherTeam/PojavLauncher_iOS/commit/ccaa9416f182dad0bc26832cbec85b799ae47dad#diff-519bd8ebea7da0ac87f1a265f80e6a39ab0eedd1b04f902b1795d564cdb00f07
    #import <spawn.h>
#import <dlfcn.h>
#import "utils.h"
...
__attribute__((constructor)) static void entry(int argc, char **argv) 
{
    ...
    if(result == 1)
        ShowAlert(@"Success", @"JIT was enabled.");
    if(result == 0)
